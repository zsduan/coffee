...
function getSkuImgValue(sku, selectedSku) {
  ...
  sku.tree.some(function (item) {
    ...
    if (id && item.v) {
      ...
      if (img) {
        imgValue = _extends(_extends({}, matchedSku), {}, {
          ks: item.k_s,
          imgUrl: img
        });
        return true;
  ...
  methods: {
    ...
    onPreviewImg: function onPreviewImg(event) {
      ...
      var skuValue = this.skuValue,
          skuKeyStr = this.skuKeyStr;
      this.skuEventBus.$emit('sku:previewImage', _extends(_extends({}, skuValue), {}, {
        ks: skuKeyStr,
...
/* harmony default export */ var Sku = (Sku_createComponent({
  ...
  methods: {
    ...
    onPreviewImage: function onPreviewImage(selectedValue) {
      ...
      var params = _extends(_extends({}, selectedValue), {}, {
        index: index,
    ...
    onStepperState: function onStepperState(data) {
      this.stepperError = data.valid ? null : _extends(_extends({}, data), {}, {
        action: 'plus'
      });
    },
